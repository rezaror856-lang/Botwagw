...
const divider = chalk.gray('═'.repeat(50))   
   console.log(divider)
console.log(chalk.bold.magenta('         [ Made By Ramaa GnnZ ]'))
console.log(divider)
console.log(chalk.bold.yellow('\n  📦 ADMIN MENYEDIAKAN:\n'))
console.log(chalk.white('  ✅  SC Bot Topup Full Button'))
console.log(chalk.white('  ✅  SC Bot Topup No Button'))
console.log(chalk.white('  ✅  Script Create Panel'))
console.log(chalk.white('  ✅  Script MD'))
console.log(chalk.white('  ✅  SC Bot Store No Enc'))
console.log(chalk.white('  ✅  SC Bot Auto Order Digital Produk'))
console.log(chalk.white('  ✅  Jasa pembuatan script sesuai keinginan'))
console.log(chalk.bold.green('\n  📱 NO WA: 0831-4271-7431\n'))
console.log(chalk.bold.green('\n  🪩 Website: adalah\n'))
console.log(divider)
